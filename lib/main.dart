...
import 'package:flight_booking/view/splash_screen.dart';
    ...
    return MultiProvider(
        providers: [
          ChangeNotifierProvider(
              create: (context) => FlightBookingController()),
          ChangeNotifierProvider(create: (context) => FlightSearchController()),
        ],
        child: MaterialApp(
          title: 'Flutter Demo',
          theme: ThemeData(
